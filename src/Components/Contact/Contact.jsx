    ...
    <div className=' bg-pink-200 h-screen overflow-hidden'>
        ...
        <div class="grid grid-cols-1 gap-6 mt-4">
            <div className='flex flex-col justify-center items-center'>
                <label class="text-pink-800 dark:text-pink- text-2xl" for="username">Username</label>
            ...
            <div className='flex flex-col justify-center items-center'>
                <label class="text-pink-800 text-2xl" for="emailAddress">Email Address</label>
            ...
            <div className='flex flex-col justify-center items-center'>
                <label class="text-pink-800 text-2xl" for="password">Password</label>
            ...
            <div className='flex flex-col justify-center items-center'>
                <label class="text-pink-800 text-2xl" for="passwordConfirmation">Password Confirmation</label>
