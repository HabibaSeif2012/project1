...
export default function Portifilio() {
  return (
    ...
    <div className='bg-pink-200 h-screen overflow-hidden  '>
        ...
        <div className=' flex-wrap justify-center p-6 flex items-center sm:mt-3 lg:mt-9 '>

          <div className='relative group px-2 mb-2 lg:w-1/3 sm:w-full overflow-hidden group-hover:transition-all group-hover:duration-[2s]  '>
          <img src={rov} alt="" className='w-[100%]  lg:ml-4 rounded-md  ' />
          <div className='bg-pink-300 bg-opacity-50 absolute  lg:ml-4 rounded-md group-hover:top-0 group-hover:right-0 group-hover:bottom-0 group-hover:left-0 transform translate-x-full group-hover:translate-x-0 transition-all duration-00  w-full sm:w-full  ' >
          ...
          <div className='relative lg:w-1/3 px-2 mt-3 sm:w-full group overflow-hidden group-hover:transition-all group-hover:duration-[2s]   '>
          <img src={signin} alt="" className='w-[100%]  rounded-md  ' />
          <div className='bg-pink-300 bg-opacity-50 absolute rounded-md group-hover:top-0 group-hover:right-0 group-hover:bottom-0 group-hover:left-0 transform translate-x-full group-hover:translate-x-0 transition-all duration-00  w-[100%] sm:w-full' >
          ...
          <div className='relative px-2 lg:w-1/3 mt-5 sm:w-full  group overflow-hidden group-hover:transition-all group-hover:duration-[2s]  '>
